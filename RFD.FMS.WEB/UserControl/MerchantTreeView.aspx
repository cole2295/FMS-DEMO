<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchantTreeView.aspx.cs" Inherits="RFD.FMS.WEB.UserControl.MerchantTreeView" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
         ...
         function fnSelectChecked(mKey, mName) {
             ...
             window.dialogArguments.RunOnPageChange(mKey);
             window.close();
         }
    </script>
</head>
<body>
    <form id="form1" runat="server" target="winMerchantTree">
    <div id="Treeview" style="overflow-x:auto;overflow-y:auto; width:360px; height:360px; padding:20px; font-size:13px;">
        <div>
        ...
        <asp:Panel ID="pOk" runat="server">
            <div style=" width:300px; height:25px; text-align:right; padding-right:20px; clear:both; border:0px solid red;">
                <div style="float:left"><asp:Button ID="btOK" runat="server" Text="确定" onclick="btOK_Click" /></div>
                <div style="float:right; color:Red;">一个都不选表示全选</div>
            </div>
        </asp:Panel>
        <div id="divMerchantTreeView" style="overflow-x:auto; width:350px; height:320px; font-size:14px;">
        <asp:TreeView ID="tree" runat="server" ShowLines="true" 
