<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeListPop.aspx.cs"
    Inherits="RFD.FMS.WEB.UserControl.EmployeeListPop" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function SelectTRE(mKey, mName) {
            window.opener.SetValueE(mKey, mName);
            window.close();
        }
    </script>

</head>
<body onunload="window.opener.IsPopEmploy = null;" class="BodyPop">
