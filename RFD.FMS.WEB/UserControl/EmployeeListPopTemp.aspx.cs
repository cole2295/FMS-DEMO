...
{
    public partial class EmployeeListPopTemp : BasePage
    {
        ...
        private void BuidPage()
        {
            ...
            else
            {
                for (int i = 0; i < GridView1.Rows.Count; i++)
                {
                    ...
                    GridView1.Rows[i].Attributes.Add("onclick", "SelectTRETemp('" + dataTable.Rows[i]["序号"].ToString() + "','" + dataTable.Rows[i]["员工名称"].ToString() + "','" + dataTable.Rows[i]["员工编码"].ToString() + "')");
