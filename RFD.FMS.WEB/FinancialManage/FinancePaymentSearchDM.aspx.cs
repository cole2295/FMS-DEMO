...
{
    public partial class FinancePaymentSearchDM : FMSBasePage
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
                ...
                UCMerchantSource.SelectEnable = false;
			}
		...
		protected override SearchCondition BuildSearchCondition(SearchType searchType)
		{
			...
			switch (searchType)
			{
				case SearchType.Total:
                    ...
                    condition.MerchantIDs = UCMerchantSource.SelectMerchantSourcesID;
                    condition.MerchantName = UCMerchantSource.SelectMerchantSourcesName;
		...
		{
            return service.GetTotalFinanceDataNewDis(condition);
		}
		...
		protected void gvSummary_Sorting(object sender, GridViewSortEventArgs e)
		{
			...
			var condition = new SearchCondition()
			{
                ...
                MerchantIDs = UCMerchantSource.SelectMerchantSourcesID,
        ...
        protected void ddlOrderSource_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                UCMerchantSource.SelectEnable = true;
            }
            else
            {
                UCMerchantSource.SelectEnable = false;
