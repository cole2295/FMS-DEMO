<%@ Page Title="" Language="C#" MasterPageFile="~/Main/main.Master" AutoEventWireup="true"
    CodeBehind="FinancePaymentSearch.aspx.cs" Inherits="RFD.FMS.WEB.FinancialManage.FinancePaymentSearch"
    Theme="default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>
                <uc1:UCMerchantSourceTV ID="UCMerchantSourceTV" runat="server" Editable="false" MerchantLoadType="ThirdMerchant" MerchantTypeSource="cw_Merchant_Inside" MerchantShowCheckBox="True" />
            </td>
            <td>
                选择站点：
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="Button1" runat="server" Text="查询V2" OnClick="btnSearch_ClickV2" />
