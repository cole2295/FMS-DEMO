...
namespace RFD.FMS.WEBLOGIC.BasicSetting
{
    ...
    {
    	private ITypeRelationService OracleService;
        ...
        public List<TypeRelationModel> SearchRelationList(string typeSource, string distributionCode)
        {
			...
			{
				return OracleService.SearchRelationList(typeSource, distributionCode);
			}
        ...
        private List<TypeRelationModel> TransforToTypeRelationModelList(DataTable dt)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                model.IsDelete = DataConvert.ToBoolean(dr["IsDelete"]);
        ...
        public bool AddTypeRelation(TypeRelationModel model)
        {
            if (OracleService != null)
            {
                return OracleService.AddTypeRelation(model);
            }
        ...
        public bool UpdateTypeRelation(TypeRelationModel model)
        {
            if (OracleService != null)
            {
                return OracleService.UpdateTypeRelation(model);
            }
        ...
        public bool DelTypeRelation(TypeRelationModel model)
        {
            if (OracleService != null)
            {
                return OracleService.DelTypeRelation(model);
            }
        ...
        public bool SetTypeRelation(TypeRelationModel model)
        {
            if (OracleService != null)
            {
                return OracleService.SetTypeRelation(model);
            }
			...
			//if (OracleService!=null)
			//{
			//    OracleService.SetTypeRelation(model);
			//}
			return true;
        }
        ...
        public List<TypeRelationModel> SearchPeriodRelationList(string typeSource, string distributionCode, string relationName, ref PageInfo pi)
        {
            if (OracleService != null)
            {
                return OracleService.SearchPeriodRelationList(typeSource, distributionCode,relationName,ref pi);
            }
