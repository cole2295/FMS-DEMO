...
namespace RFD.FMS.WEBLOGIC.BasicSetting
{
    public class AccountPeriodService : IAccountPeriodService
    {
        ...
        private IAccountPeriodService OracleService;

        public bool AddAccountPeriod(AccountPeriod ap)
        {
            IIDGenerateService iDGenerate = ServiceLocator.GetService<IIDGenerateService>();
            ap.AccountPeriodKid = iDGenerate.NewId("FMS_AccountPeriod", "AccountPeriodKid");
            //新增
            if(OracleService!=null)
            {
                return OracleService.AddAccountPeriod(ap);
            }
        ...
        public List<AccountPeriod> SearchAccountPeriod(AccountPeriodCondition apc)
        {
            if (OracleService != null)
            {
                return OracleService.SearchAccountPeriod(apc);
            }
        ...
        public bool UpdateAccountPeriod(AccountPeriod ap)
        {
            ...
            if (OracleService != null)
            {
                return OracleService.UpdateAccountPeriod(ap);
            }
        ...
        public string ImitatePeriod(AccountPeriod ap)
        {
            if (OracleService != null)
            {
                return OracleService.ImitatePeriod(ap);
            }
