...
namespace RFD.FMS.WEBLOGIC.BasicSetting
{
    ...
    */
	public class DeliverFeeService : IDeliverFeeService
	{
		...
		private IDeliverFeeService OracleService;
		...
		public void BindStatus(ListControl bindControl, MaintainStatus status)
		{
			...
			{
				OracleService.BindStatus(bindControl, status);
				return;
			}
		...
		public void BindStatus(ListControl bindControl, MaintainStatus status, bool IsAddAllOption, bool IsDefaultSelected)
		{
			if (OracleService != null)
			{
				OracleService.BindStatus(bindControl, status, IsAddAllOption, IsDefaultSelected);
				return;
			}
		...
		public void BindFactors(ListControl bindControl)
		{
			if (OracleService != null)
			{
				OracleService.BindFactors(bindControl);
				return;
			}
		...
		public DataTable BindDeliverFeeList(SearchCondition condition,ref PageInfo pi)
		{
			if (OracleService != null)
			{
				return OracleService.BindDeliverFeeList(condition,ref pi);
			}
            ...
            //待生效未添加sql
			var data = _fMS_MerchantDeliverFeeDao.GetMerchantDeliverFeeList(condition,pi);
		...
		public DataTable BindDeliverFeeListHistory(SearchCondition condition)
		{
			if (OracleService != null)
			{
				return OracleService.BindDeliverFeeListHistory(condition);
			}
		...
		public bool SaveDeliverFee(FMS_MerchantDeliverFee merchant)
		{
            if (OracleService != null)
            {
                return OracleService.SaveDeliverFee(merchant);
            }
			using (IUnitOfWork scope = TranScopeFactory.CreateUnit())
			{
        ...
        public bool SaveEffectDeliverFee(RFD.FMS.MODEL.FMS_MerchantDeliverFee merchant)
        {
            if(OracleService!=null)
            {
                return OracleService.SaveEffectDeliverFee(merchant);
            }
            throw new Exception("sql中没有实现添加待生效");
        }
		...
		public bool UpdateDeliverFee(FMS_MerchantDeliverFee merchant)
		{
            if (OracleService != null)
            {
                return OracleService.UpdateDeliverFee(merchant);
            }
			using (IUnitOfWork scope = TranScopeFactory.CreateUnit())
			{
        ...
        public bool UpdateEffectDeliverFee(FMS_MerchantDeliverFee merchant)
        {
            if (OracleService != null)
            {
                return OracleService.UpdateEffectDeliverFee(merchant);
            }
            throw new Exception("sql中没有实现待生效功能");
        }
		...
		public IDictionary<int, string> GetMerchantDictionary()
		{
			if (OracleService != null)
			{
				return OracleService.GetMerchantDictionary();
			}
		...
		public string GetMerchantNameFromDictionary(int merchantID)
		{
			if (OracleService != null)
			{
				return OracleService.GetMerchantNameFromDictionary(merchantID);
			}
		...
		public bool CheckImportData(DataTable uploadData, DataTable template, out string error)
		{
			if (OracleService != null)
			{
				return OracleService.CheckImportData(uploadData, template, out error);
			}
			error = string.Empty;
		...
		public DataTable SearchStationDeliverFee(FMS_StationDeliverFee model)
		{
			if (OracleService != null)
			{
				return OracleService.SearchStationDeliverFee(model);
			}
		...
		public bool UpdateMerchantDeliverFeeStatus(IList<KeyValuePair<string, string>> checkList, int status, int auditBy, string distributionCode)
		{
            if (OracleService != null)
            {
                return OracleService.UpdateMerchantDeliverFeeStatus(checkList, status, auditBy, distributionCode);
            }
			...
			//if (OracleService != null)
			//{
			//    OracleService.UpdateMerchantDeliverFeeStatus(checkList, status, auditBy, distributionCode);
			//}
			return true;
		}
        ...
        public bool UpdateEffectMerchantDeliverFeeStatus(IList<KeyValuePair<string, string>> checkList, int status, int auditBy, string distributionCode)
        {
            if (OracleService != null)
            {
                return OracleService.UpdateEffectMerchantDeliverFeeStatus(checkList, status, auditBy, distributionCode);
            }
            throw new Exception("sql中没有实现待生效功能");
        }
        ...
        public int GetEffectMerchantDeliverByMerchantID(int merchantId)
        {
            if (OracleService != null)
            {
                return OracleService.GetEffectMerchantDeliverByMerchantID(merchantId);
            }
        ...
        public bool DeleteWaitMerchantDeliverFee(string feeid)
        {
            if (OracleService != null)
            {
                return OracleService.DeleteWaitMerchantDeliverFee(feeid);
            }
            throw new Exception("sql中没有实现待生效功能");
        }
	}
