...
{
    public class M2S_FMS_CODReturnsCount : SyncBase
    {
        private SyncSelectParam ssParam = SyncSelectParamByConfig.Instance.GetParam("FMS_CODReturnsCount");

        protected override DataSet GetSyncData()
        {
            SyncDao _dao = new SyncDao();

            DataSet ds = _dao.GetDataSet(DBStr.DbFromConnString, string.Format(SqlCollectionM2S.sqlCODReturnsCount, ssParam.Where, ssParam.TopN));
        ...
        protected override SyncTable GetSynStructFrom()
        {
            string userSql = @" UPDATE o SET o.ischange = 0
                                from FMS_CODReturnsCount as o join {0} as f on o.AccountID = f.AccountID
                                where o.ischange=1";
        ...
        {
            SyncTable t = new SyncTable("FMS_CODReturnsCount", HowTableUpdate.TableInsertAndUpdate);
            t.Cols.Add(new SyncCol("AccountID", "bigint", true));
            ...
            t.Cols.Add(new SyncCol("ReturnsType", "tinyint"));
        ...
        {
            return "M2S_FMS_CODReturnsCount";
        }
    }
}
