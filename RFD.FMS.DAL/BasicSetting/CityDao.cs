 ...
 * 修改记录：
 */
    public class CityDao : SqlServerDao, ICityDao
    {
        /// <summary>
        /// 根据条件查询城市信息
        /// </summary>
        ...
        {
            string sqlGetCityList = "SELECT CityID,CityName FROM RFD_PMS.dbo.City(NOLOCK) WHERE ISDELETED=0";
            //城市ID
            ...
            DataTable dataTable = SqlHelper.ExecuteDataset(Connection, CommandType.Text, sqlGetCityList).Tables[0];
            return dataTable;
        }
    }
}
